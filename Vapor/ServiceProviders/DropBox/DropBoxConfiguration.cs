...
namespace AppLimit.CloudComputing.SharpBox.StorageProvider.DropBox
{
	...
	public class DropBoxConfiguration : ICloudStorageConfiguration
	{
        ...
        public Uri RequestTokenUrl
        {
            get
            {
                return new Uri(DropBoxStorageProviderService.GetUrlString(DropBoxStorageProviderService.DropBoxOAuthRequestToken, this));
            }
        }
		...
		public Uri AccessTokenUrl
        {
            get
            {
                return new Uri(DropBoxStorageProviderService.GetUrlString(DropBoxStorageProviderService.DropBoxOAuthAccessToken, this));
            }
        }
        ...
        public Uri AuthorizationTokenUrl
        {
            get
            {
                return new Uri(DropBoxStorageProviderService.GetUrlString(DropBoxStorageProviderService.DropBoxOAuthAuthToken, null));            
            }
        }
